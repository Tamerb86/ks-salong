...
export default function Landing() {
  useEffect(() => {
    // Set SEO meta tags
    document.title = "K.S Salong - Norgesmester 2022 | Frisørsalong i Porsgrunn";
    ...
    metaDescription.setAttribute('content', 'K.S Salong - Prisbelønt frisørsalong i Porsgrunn. Norgesmester 2022. Profesjonelle tjenester for herre og dame. Book time online. 5 stjerner fra 55+ fornøyde kunder.');
    ...
    metaKeywords.setAttribute('content', 'frisør porsgrunn, herreklipp, dameklipp, skjegg trim, hårfarge, K.S Salong, norgesmester frisør, beste frisør porsgrunn');
  }, []);
      ...
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-gray-900">K.S Salong</span>
          </div>
      ...
      <section id="om-oss" className="py-20 bg-gradient-to-br from-purple-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6 text-gray-900">Om K.S Salong</h2>
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                Velkommen til K.S Salong, en ledende frisørsalong i hjertet av Porsgrunn. 
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                ...
                skiller K.S Salong seg ut som et enestående valg for de som søker det beste innen hårpleie.
              </p>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">K.S Salong</span>
              </div>
              <p className="text-sm">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
            <p>&copy; 2026 K.S Salong. Alle rettigheter reservert.</p>
